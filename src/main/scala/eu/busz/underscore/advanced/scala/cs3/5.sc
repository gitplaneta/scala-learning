...
val splitEmail: Check[Errors, String, (String, String)] = Check(a => a.split('@') match {
  case Array(left, right) => (left, right).validNel[String]
  case _ => "Could not split string".invalidNel[(String, String)]
})
